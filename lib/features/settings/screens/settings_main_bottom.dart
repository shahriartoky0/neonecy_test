...
import '../controllers/settings_bottom_nav.dart';

class SettingsMainBottomNav extends GetView<SettingsBottomNavController> {
  const SettingsMainBottomNav({super.key});
